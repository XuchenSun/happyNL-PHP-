...
<div id="account" class="container mt-4 pt-5">
    ...
    <p class="text-center text-muted"> Operation About Account</p>
    <div class="container">
        <div class="row justify-content-md-center" >
            <button
                    type="button"
                    class="btn btn-light border-success ml-2 px-4 mt-2"
                    onclick="window.location.href='reset-password.php'"
            >
                Reset Password
...
<div class="container pt-4">
    ...
    <div class="row row-cols-1 row-cols-md-4">
        ...
        <div class="col mb-4">
            <div class="card h-100" onclick="window.location.href='https://www.gov.nl.ca/covid-19/vaccine/gettheshot/'">
                <img src="img/vaccine.jpg" class="card-img-top" alt="..." height="200">
                <div class="card-body">
                    <h5 class="card-title" style="overflow: hidden" >Get the Vaccine</h5>
                    <p class="card-text">&#160&#160&#160&#160&#160&#160 This is a page to book free vaccine from NL government .</p>
                </div>
            </div>
        </div>
        <div class="col mb-4">
            <div class="card h-100" onclick="window.location.href='https://www.gov.nl.ca/covid-19/'">
                <img src="img/news.jpg" class="card-img-top" alt="..." height="200">
                <div class="card-body">
                    <h5 class="card-title" style="overflow: hidden" >Life With Covid-19</h5>
                    <p class="card-text">&#160&#160&#160&#160&#160&#160 This page shows some up-to-date information related to Cov19 from government.</p>
                </div>
            </div>
        </div>
...
<div id="download" class="container mt-4 pt-5">
    <h1 class="text-center" style="font-weight: bold;overflow: hidden;">Download</h1>
    <p class="text-center text-muted">There are some useful software.</p>
    <!>
    <p class="text-center text-muted" style="margin-top: -15px !important"> All of them are free to download and use.
    </p>
</div>
...
<div class="container pt-4">
    <div class="col mb-4">
        <div class="card h-100" onClick="window.location='happyNL(currently developing).jar'">
            <img src="img/desk.jpg" class="card-img-top" alt="..." width="100">
            <div class="card-body">
                <h5 class="card-title" style="overflow: hidden" >happyNL(Desktop App)</h5>
                <p class="card-text">&#160&#160&#160&#160&#160&#160 Desktop App.</p>
            </div>
        </div>
    </div>
</div>
